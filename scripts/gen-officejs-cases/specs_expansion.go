...
func commentExpansionSpecs() []spec {
	cases := []struct{ name, call string }{
		...
		{"null", `const found = comments.getItemOrNullObject("{00000000-0000-0000-0000-000000000000}"); await context.sync(); output = found.isNullObject;`},
		...
		{"reply_null", `const found = first.replies.getItemOrNullObject("{00000000-0000-0000-0000-000000000000}"); await context.sync(); output = found.isNullObject;`},
...
func conditionalExpansionSpecs() []spec {
	cases := []struct{ name, call string }{
		...
		{"null", `const found = formats.getItemOrNullObject("999"); await context.sync(); output = found.isNullObject;`},
